...
<?php
        ...
        if (isset($_GET['search'])) {
            $search = $_GET['search'];
            // Perform a database query to search for papers
            $sql = "SELECT referaty.referat_id, referaty.title, category.category_name, referaty.created_at, referaty.skola, user.name 
                    FROM referaty 
